...
class ManageUserFrame extends JFrame {
    private String role;
    ...
    public ManageUserFrame(String role, String filename) {
        this.role = role;
        ...
        // --- South Panel: Input Fields and CRUD Buttons ---
        ...
        gbc.gridx = 1;
        gbc.weightx = 1.0; // Give horizontal space to text field
        ...
        gbc.gridx = 1;
        gbc.weightx = 1.0; // Give horizontal space to combo box
        String[] genders = {"Male", "Female", "Other"};
        genderComboBox = createGenderComboBox(genders);
        southPanel.add(genderComboBox, gbc);
        gbc.weightx = 0; // Reset weightx
        
        // Add some horizontal space between left and right input columns
        gbc.gridx = 2;
        gbc.gridy = 0;
        ...
        // Add some horizontal space between inputs and CRUD buttons
        gbc.gridx = 5;
        gbc.gridy = 0;
        gbc.gridheight = 3;
        southPanel.add(Box.createRigidArea(new Dimension(50, 0)), gbc);
        ...
        readUsers(); // Load users initially
        setVisible(true);
    }
    ...
    private JTextField createInputField() {
        ...
        field.setPreferredSize(new Dimension(200, 30)); // Explicitly set preferred size
        field.setMinimumSize(new Dimension(200, 30)); // Ensure it doesn't shrink
        field.setFont(new Font("SansSerif", Font.PLAIN, 16));
        return field;
    }

    private JComboBox<String> createGenderComboBox(String[] options) {
        JComboBox<String> comboBox = new JComboBox<>(options);
        comboBox.setPreferredSize(new Dimension(200, 30)); // Consistent size
        comboBox.setMinimumSize(new Dimension(200, 30)); // Ensure it doesn't shrink
    ...
    private void readUsers() {
        ...
        try {
            List<User> users = User.loadFromFile(filename, role);
            for (User u : users) {
